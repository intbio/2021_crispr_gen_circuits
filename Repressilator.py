...
fig.circle('x','ylacI', source=source, size = 1, color = 'blue')
fig.circle('x','ytetR', source=source, size = 1, color = 'green')
fig.circle('x','ylambda', source=source, size = 1, color = 'red')
